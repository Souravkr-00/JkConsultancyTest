        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-2/5 lg:pr-12 mb-10 lg:mb-0">
            <div className="sticky top-20">
              <div className="mb-2">
                <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">FREE CONSULTATION</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Book Your Abroad Studies Consultation</h1>
              <p className="text-gray-600 mb-8">
                Schedule a personalized consultation with our expert advisors to discuss your study abroad options, application process, visa requirements, and more.
              </p>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">consultations@studyabroad.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Education Street, Suite 400<br />New York, NY 10001</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 md:p-10">
              {submissionStatus === 'success' ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-600 mb-6">Your consultation request has been received. We'll contact you shortly to confirm your appointment.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-1">
                      <label htmlFor="countryInterest" className="block text-gray-700 font-medium mb-2">Interested Country *</label>
                      <select
                        id="countryInterest"
                    ...
                    <div className="col-span-2 md:col-span-1">
                      <label htmlFor="studyLevel" className="block text-gray-700 font-medium mb-2">Study Level *</label>
                      <select
                        id="studyLevel"
                        name="studyLevel"
                    ...
                    <div className="col-span-2">
                      <label htmlFor="preferredProgramme" className="block text-gray-700 font-medium mb-2">Preferred Programme/Course</label>
                      <input
                        type="text"
                    ...
                    <div className="col-span-2 md:col-span-1">
                      <label htmlFor="budget" className="block text-gray-700 font-medium mb-2">Approximate Budget (USD/year)</label>
                      <select
                        id="budget"
                        name="budget"
                    ...
                    <div className="col-span-2 md:col-span-1">
                      <label htmlFor="englishProficiency" className="block text-gray-700 font-medium mb-2">English Proficiency Test Status</label>
                      <select
